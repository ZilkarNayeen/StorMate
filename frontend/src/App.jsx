    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          <Route element={<ProtectedRoutes requireRole={['admin', 'superadmin', 'staff']} />}>
            ...
            <Route path="/admin-dashboard" element={<Dashboard />}>
              ...
              {/* Nested protection for users page - only admin and superadmin */}
              <Route element={<ProtectedRoutes requireRole={['admin', 'superadmin']} />}>
